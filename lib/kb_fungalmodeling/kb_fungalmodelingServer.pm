package kb_fungalmodeling::kb_fungalmodelingServer;
...
sub call_method {
    ...
    my $ctx = kb_fungalmodeling::kb_fungalmodelingServerContext->new($self->{loggers}->{userlog},
...
{
    # Service kb_fungalmodeling requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for kb_fungalmodeling but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = kb_fungalmodeling::kb_fungalmodelingServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service kb_fungalmodeling.");
    }
...
package kb_fungalmodeling::kb_fungalmodelingServerContext;

use strict;

=head1 NAME

kb_fungalmodeling::kb_fungalmodelingServerContext
...
package kb_fungalmodeling::kb_fungalmodelingServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = kb_fungalmodeling::kb_fungalmodelingServer->new(
